...
class MistralEngine(Engine):
    def __init__(self, lora_path, parameters, system_description, cpu_offload=True):
        ...
        device_map = {'model.embed_tokens': 0, 'model.layers.0': 0, 'model.layers.1.self_attn': 0, 'model.layers.1.block_sparse_moe.gate': 0, 'model.layers.1.block_sparse_moe.experts.0': 0, 'model.layers.1.block_sparse_moe.experts.1': 0, 'model.layers.1.block_sparse_moe.experts.2': 0, 'model.layers.1.block_sparse_moe.experts.3': 0, 'model.layers.1.block_sparse_moe.experts.4': 0, 'model.layers.1.block_sparse_moe.experts.5': 0, 'model.layers.1.block_sparse_moe.experts.6': 0, 'model.layers.1.block_sparse_moe.experts.7.w1': 0, 'model.layers.1.block_sparse_moe.experts.7.w2': 0, 'model.layers.1.block_sparse_moe.experts.7.w3': 'cpu', 'model.layers.1.block_sparse_moe.experts.7.act_fn': 'cpu', 'model.layers.1.input_layernorm': 'cpu', 'model.layers.1.post_attention_layernorm': 'cpu', 'model.layers.2': 0, 'model.layers.3': 0, 'model.layers.4': 0, 'model.layers.5': 0, 'model.layers.6': 0, 'model.layers.7': 0, 'model.layers.8': 0, 'model.layers.9': 'cpu', 'model.layers.10': 'cpu', 'model.layers.11': 'cpu', 'model.layers.12': 'cpu', 'model.layers.13': 'cpu', 'model.layers.14': 'cpu', 'model.layers.15': 'cpu', 'model.layers.16': 'cpu', 'model.layers.17': 'cpu', 'model.layers.18': 'cpu', 'model.layers.19': 'cpu', 'model.layers.20': 'cpu', 'model.layers.21': 'cpu', 'model.layers.22': 'cpu', 'model.layers.23': 'cpu', 'model.layers.24': 'cpu', 'model.layers.25': 'cpu', 'model.layers.26': 'cpu', 'model.layers.27.self_attn': 'cpu', 'model.layers.27.block_sparse_moe.gate': 'cpu', 'model.layers.27.block_sparse_moe.experts.0': 'cpu', 'model.layers.27.block_sparse_moe.experts.1': 'cpu', 'model.layers.27.block_sparse_moe.experts.2.w1': 'cpu', 'model.layers.27.block_sparse_moe.experts.2.w2': 'disk', 'model.layers.27.block_sparse_moe.experts.2.w3': 'disk', 'model.layers.27.block_sparse_moe.experts.2.act_fn': 'disk', 'model.layers.27.block_sparse_moe.experts.3': 'disk', 'model.layers.27.block_sparse_moe.experts.4': 'disk', 'model.layers.27.block_sparse_moe.experts.5': 'disk', 'model.layers.27.block_sparse_moe.experts.6': 'disk', 'model.layers.27.block_sparse_moe.experts.7': 'disk', 'model.layers.27.input_layernorm': 'disk', 'model.layers.27.post_attention_layernorm': 'disk', 'model.layers.28': 'disk', 'model.layers.29': 'disk', 'model.layers.30': 'disk', 'model.layers.31': 'disk', 'model.norm': 'disk', 'lm_head': 0'}
        print("@@@@@@@@@@@@@")
        print(device_map)
        print("-------------")
        self.hf_model = AutoModelForCausalLM.from_pretrained(
